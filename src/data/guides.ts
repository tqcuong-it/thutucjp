...
export const guides: Guide[] = [
  ...
  {
    id: 'birth-allowance-japan',
    title: 'Trợ cấp sinh con — Sinh ở Nhật 🇯🇵',
    titleJp: '出産育児一時金（国内出産）',
    category: 'baby',
    categoryIcon: '👶',
    description: 'Sinh con tại bệnh viện Nhật → được trợ cấp ¥500,000/bé. Bệnh viện thường làm giúp, bạn chỉ trả phần chênh lệch.',
    difficulty: 'easy',
    estimatedTime: '15 phút (ký giấy tại bệnh viện)',
    fee: 'Miễn phí',
    deadline: '2 năm kể từ ngày sinh',
    where: 'Bệnh viện (直接支払制度) — hoặc 健保組合/市役所 nếu xin sau',
    steps: [
      {
        title: '1. Trước khi sinh — Hỏi bệnh viện',
        description: 'Khi khám thai, hỏi bệnh viện: 「直接支払制度はありますか？」(Có chế độ thanh toán trực tiếp không?)',
        tips: [
          '🏥 **90% bệnh viện có** 直接支払制度 — bạn không cần làm gì thêm',
          '📋 Nếu KHÔNG có → hỏi về 受取代理制度（bệnh viện nhận thay）',
          '💡 Chọn bệnh viện → hỏi ngay từ lần khám đầu tiên',
        ],
      },
      {
        title: '2. Lúc nhập viện sinh — Ký 1 tờ giấy',
        description: 'Bệnh viện đưa form「直接支払制度利用合意書」→ ký tên là xong!',
        tips: [
          '✅ Bệnh viện tự claim ¥500,000 từ bảo hiểm của bạn',
          '💰 Bạn CHỈ TRẢ PHẦN CHÊNH LỆCH — VD: phí sinh ¥600,000 → bạn trả ¥100,000',
          '🎉 Nếu phí sinh < ¥500,000 → được trả lại phần thừa!',
        ],
      },
      {
        title: '3. Sau sinh — Trả tiền xuất viện',
        description: 'Khi xuất viện, bệnh viện tính:',
        tips: [
          '📊 **Tổng phí sinh** − ¥500,000 = **số tiền bạn trả**',
          '💳 Thanh toán tại quầy bệnh viện (tiền mặt hoặc card)',
          '📄 Giữ lại tất cả hóa đơn → cần cho 医療費控除 (khấu trừ thuế y tế cuối năm)',
        ],
      },
      {
        title: '4. Nếu phí sinh < ¥500,000 → Xin hoàn tiền thừa',
        description: 'VD: phí sinh ¥420,000 → được hoàn ¥80,000. Nộp đơn 差額申請:',
        tips: [
          '🏢 **健保組合 (bảo hiểm công ty)** → hỏi HR hoặc liên hệ 健保 trực tiếp',
          '🏛️ **国保 (bảo hiểm quốc dân)** → nộp tại 市役所 quầy 保険年金課',
          '📋 Cần: 申請書 + 出産証明書 + 明細書 + 通帳',
          '💰 Nhận tiền sau 1-2 tháng qua chuyển khoản',
        ],
      },
      {
        title: '5. Đồng thời — Đăng ký khai sinh + 児童手当',
        description: 'Trong 14 ngày sau sinh, làm luôn:',
        tips: [
          '📝 **出生届（khai sinh）** — nộp ở 市役所 trong 14 ngày',
          '💰 **児童手当（phụ cấp trẻ em）** — nộp trong 15 ngày → ¥15,000/tháng',
          '🏥 **健康保険（bảo hiểm cho bé）** — đăng ký bé vào bảo hiểm cha/mẹ',
          '🛂 **在留資格（visa cho bé）** — nộp trong 30 ngày (nếu bé là người nước ngoài)',
          '📕 **パスポート + 在留カード** — xin hộ chiếu VN cho bé tại Đại sứ quán',
        ],
        warning: '児童手当: nộp muộn = mất tiền tháng đó! Nộp ngay trong 15 ngày.',
      },
    ],
    requiredDocs: [
      '健康保険証（thẻ bảo hiểm — của mẹ hoặc cha）',
      '母子手帳（sổ tay mẹ bầu）',
      '印鑑（con dấu — tùy bệnh viện）',
      '通帳（sổ ngân hàng — nếu xin hoàn tiền thừa）',
    ],
    faq: [
      {
        q: 'Sinh đôi thì sao?',
        a: 'Mỗi bé ¥500,000. Sinh đôi = ¥1,000,000! Sinh ba = ¥1,500,000!',
      },
      {
        q: 'Vợ ở nhà không đi làm (家族滞在) thì ai nhận?',
        a: 'Xin qua bảo hiểm của chồng（被扶養者として）. Hỏi HR công ty chồng.',
      },
      {
        q: '¥500,000 có đủ không?',
        a: 'Phí sinh trung bình: ¥450,000-¥550,000 (tỉnh lẻ), ¥550,000-¥700,000 (Tokyo). Sinh mổ + phòng cá nhân có thể > ¥800,000.',
      },
      {
        q: 'Sinh mổ có được thêm gì không?',
        a: 'Sinh mổ = phẫu thuật → được bảo hiểm chi trả 70% phần phẫu thuật. Cộng thêm 出産育児一時金 ¥500,000. Và có thể xin 高額療養費 nếu tổng vượt ngưỡng.',
      },
      {
        q: 'Cần đăng ký gì trước khi sinh?',
        a: '母子手帳 (sổ mẹ bầu) — xin ở 市役所 khi biết mang thai. Và 妊婦健診受診票 (phiếu khám thai miễn phí, ~14 lần).',
      },
    ],
    relatedLinks: [
  ...
  {
    id: 'birth-allowance-overseas',
    title: 'Trợ cấp sinh con — Sinh ở Việt Nam 🇻🇳',
    titleJp: '出産育児一時金（海外出産）',
    category: 'baby',
    categoryIcon: '👶',
    description: 'Vợ về VN sinh con vẫn được nhận ¥500,000 nếu chồng/vợ đang đóng bảo hiểm tại Nhật. Phải tự nộp đơn sau sinh.',
    difficulty: 'medium',
    estimatedTime: '1-2 tiếng (chuẩn bị giấy tờ)',
    fee: 'Miễn phí (nhưng phí dịch thuật + công chứng ~¥5,000-¥10,000)',
    deadline: '2 năm kể từ ngày sinh',
    where: '健保組合（bảo hiểm công ty）hoặc 市役所（nếu 国保）',
    steps: [
      {
        title: '1. Điều kiện nhận',
        description: 'Sinh ở Việt Nam VẪN được ¥500,000 nếu:',
        tips: [
          '✅ Chồng HOẶC vợ đang có bảo hiểm sức khỏe tại Nhật (健康保険 hoặc 国民健康保険)',
          '✅ Vợ là 被扶養者（người phụ thuộc）trên bảo hiểm chồng → OK',
          '✅ Vợ tự đóng 国保 → OK',
          '❌ Nếu CẢ HAI đều không có bảo hiểm Nhật → KHÔNG được',
        ],
        warning: 'Kiểm tra bảo hiểm TRƯỚC khi về VN sinh. Nếu vợ rời khỏi Nhật > 1 năm → có thể mất tư cách 被扶養者!',
      },
      {
        title: '2. Trước khi về VN — Chuẩn bị',
        description: 'Làm TRƯỚC khi lên máy bay:',
        tips: [
          '📋 Hỏi 健保組合/市役所 lấy form **出産育児一時金支給申請書**',
          '📋 Hỏi cần những giấy tờ gì (mỗi 健保 có thể khác nhau)',
          '🛂 Kiểm tra 在留カード còn hạn → nếu gần hết hạn, gia hạn trước',
          '📕 Nếu vợ là người phụ thuộc → giữ nguyên bảo hiểm, ĐỪNG hủy',
          '💡 Hỏi HR công ty chồng xác nhận vợ vẫn là 被扶養者 khi ở VN',
        ],
      },
      {
        title: '3. Sinh con ở VN — Lấy giấy tờ',
        description: 'Sau khi sinh, xin bệnh viện VN cấp:',
        tips: [
        ...
        warning: 'QUAN TRỌNG: Tất cả giấy tờ VN phải được DỊCH sang tiếng Nhật + CÔNG CHỨNG!',
      },
      {
        title: '4. Dịch thuật + Công chứng',
        description: 'Giấy tờ VN → dịch tiếng Nhật → công chứng:',
        tips: [
      ...
      {
        title: '5. Về Nhật — Nộp đơn',
        description: 'Sau khi về Nhật (hoặc gửi bưu điện từ VN):',
        tips: [
      ...
      {
        title: '6. Thủ tục khác cho bé',
        description: 'Ngoài xin tiền trợ cấp, cần làm thêm:',
        tips: [
          '🛂 **Hộ chiếu VN cho bé** — xin tại cơ quan XNC Việt Nam',
          ...
          '💰 **児童手当** — nộp ngay khi bé có visa + 住民登録',
        ],
        warning: '出生届 cho bé sinh ở nước ngoài: hạn 3 tháng (không phải 14 ngày như sinh ở Nhật).',
      },
    ],
    requiredDocs: [
      ...
      '母子手帳（nếu có — xin ở 市役所 trước khi đi）',
      '印鑑（con dấu）',
    ],
    faq: [
      {
        q: 'Chồng ở Nhật, vợ sinh ở VN — ai nộp đơn?',
        a: 'Chồng nộp tại Nhật (nộp cho 健保組合 công ty hoặc 市役所). Vợ chỉ cần gửi giấy tờ về cho chồng.',
      },
      {
        q: 'Phí sinh ở VN rẻ hơn nhiều — có được giữ hết ¥500,000?',
        a: 'CÓ! VD: sinh ở VN hết ~5 triệu VND (~¥30,000) → bạn được giữ ~¥470,000. Đây là lý do nhiều gia đình chọn về VN sinh.',
      },
      {
        q: 'Bao lâu thì nhận tiền?',
        a: 'Sau khi nộp đủ giấy tờ: 1-3 tháng. Chậm hơn sinh ở Nhật vì cần verify giấy tờ nước ngoài.',
      },
      {
        q: 'Không về Nhật được — gửi đơn từ VN được không?',
        a: 'Tùy 健保組合. Một số chấp nhận gửi bưu điện quốc tế. Hoặc nhờ chồng/người thân ở Nhật nộp thay.',
      },
      {
        q: 'Sinh đôi ở VN?',
        a: 'Vẫn ¥500,000/bé. Sinh đôi = ¥1,000,000!',
      },
      {
        q: 'Vợ mang quốc tịch VN (chưa có bảo hiểm Nhật) thì sao?',
        a: 'Nếu vợ là 被扶養者 trên bảo hiểm chồng → OK. Nếu không có bảo hiểm Nhật nào → không được.',
      },
    ],
    relatedLinks: [
      { label: '全国健康保険協会 — 出産育児一時金', url: 'https://www.kyoukaikenpo.or.jp/g6/cat620/r310/' },
      { label: 'Đại sứ quán Nhật tại VN', url: 'https://www.vn.emb-japan.go.jp/itprtop_vi/index.html' },
    ],
  },
  {
    id: 'child-allowance',
